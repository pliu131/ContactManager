...
describe 'the person view', type: :feature do
  ...
  context 'email addresses' do
    before(:each) do
      person.email_addresses.create(address: 'user1@example.com', person_id: 1)
      person.email_addresses.create(address: 'user2@example.com', person_id: 1)
      visit person_path(person)
    end
    ...
    it 'adds a new email address' do
      ...
      fill_in('Address', with: "user@gmail.com")
